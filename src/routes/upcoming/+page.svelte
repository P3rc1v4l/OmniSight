...
<div class="page">
	...
	<div class="content">
		<h1>Upcoming</h1>
		<p class="sub">Demnächst erscheinende Filme in Deutschland (TMDB)</p>
...
<style>
	...
	.rail { display: flex; gap: 12px; overflow-x: auto; padding: 8px 0 16px; scroll-snap-type: x mandatory; }
	.tcard { flex: 0 0 160px; scroll-snap-align: start; background: var(--bg-card); border: 1px solid var(--border); border-radius: 12px; padding: 0; overflow: hidden; cursor: pointer; color: var(--text); font-family: inherit; transition: transform 0.18s, border-color 0.18s; text-align: left; }
