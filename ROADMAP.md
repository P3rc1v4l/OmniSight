...
## 🩹 v1.0.1
- Tote /settings-Route entfernt. TMDB-Pflichtnennung ergänzt (Compliance für Public-Repo/Weitergabe).
...
## 🎉 v1.0.0 – Release
- Hybrid: Desktop (Tauri) + Web (Docker, Login + TOTP-2FA, Admin-Benutzerverwaltung, TMDB-Proxy). Plattform-Abstraktion, Icon-Vereinheitlichung abgeschlossen, Recs parallel, Doku komplett. 15 Server-E2E-Tests grün.

### v1.1 (geplant)
- Serverseitige Zustands-Synchronisation pro Nutzer (Watchlist/Profile im Web geräteübergreifend).
- QR-Code beim 2FA-Setup; Backup-Codes.
- Toast-/Icon-Feinschliff Runde 2, weitere Performance (Lazy-Loading schwerer Modals).

## 🆕 v0.106.0
- 🎨 Design-System 2.0: Tokens (Motion/Schatten/Glas), Splash-Screen mit echtem Fortschritt, Seiten-Fades, Modal-Animationen, Glas-Panels (Sidebar/Suche/Palette), Hover-Tiefe, reduced-motion.

### Offen in E2 (nächster Feinschliff)
- Startseiten-Werkzeugleiste (🎲/🔄/📁/▦ …) und Toast-Icons auf Lucide; Empty-State-Politur.
